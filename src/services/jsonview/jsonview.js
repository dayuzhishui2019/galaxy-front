...
JSONFormatter = (function() {
	...
	JSONFormatter.prototype.dateToHTML = function(value) {
		return this.decorateWithSpan(value.toString(), "num");
	};
	...
	JSONFormatter.prototype.jsonToHTML = function(json) {
		return '<div class="jsonview jsonview-style">' + this.valueToHTML(json) + "</div>";
	};
...
export default function() {
	...
	if (JSONView[args[0]] != null) {
		...
		return (outputDoc = formatter.jsonToHTML(json));
		// return this.each(function() {
